...
#
# Timer.tcl: Tcl script for re-creating project 'Timer'
#
...
set files [list \
 [file normalize "${origin_dir}/src/design/BCD7Segment.vhd"] \
 [file normalize "${origin_dir}/src/design/CommandUnit.vhd"] \
 [file normalize "${origin_dir}/src/design/Counter.vhd"] \
 [file normalize "${origin_dir}/src/design/Debouncer.vhd"] \
 [file normalize "${origin_dir}/src/design/DisplayController.vhd"] \
 [file normalize "${origin_dir}/src/design/ExecutionUnit.vhd"] \
 [file normalize "${origin_dir}/src/design/FrequencyDivider.vhd"] \
 [file normalize "${origin_dir}/src/design/MSCounter.vhd"] \
 [file normalize "${origin_dir}/src/design/SignalExtender.vhd"] \
 [file normalize "${origin_dir}/src/design/Timer.vhd"] \
 [file normalize "${origin_dir}/src/design/Top.vhd"] \
]
add_files -norecurse -fileset $obj $files

# Set 'sources_1' fileset file properties for remote files
set file "$origin_dir/src/design/BCD7Segment.vhd"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "VHDL" -objects $file_obj

set file "$origin_dir/src/design/CommandUnit.vhd"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "VHDL" -objects $file_obj
...
set file "$origin_dir/src/design/DisplayController.vhd"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "VHDL" -objects $file_obj

set file "$origin_dir/src/design/ExecutionUnit.vhd"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "VHDL" -objects $file_obj

set file "$origin_dir/src/design/FrequencyDivider.vhd"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "VHDL" -objects $file_obj

set file "$origin_dir/src/design/MSCounter.vhd"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "VHDL" -objects $file_obj

set file "$origin_dir/src/design/SignalExtender.vhd"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "VHDL" -objects $file_obj

set file "$origin_dir/src/design/Timer.vhd"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "VHDL" -objects $file_obj
...
set file "[file normalize "$origin_dir/src/constraints/Basys3.xdc"]"
set file_added [add_files -norecurse -fileset $obj [list $file]]
set file "$origin_dir/src/constraints/Basys3.xdc"
set file [file normalize $file]
...
set files [list \
 [file normalize "${origin_dir}/src/testbench/TestBench.vhd"] \
 [file normalize "${origin_dir}/src/testbench/TestCounter.vhd"] \
]
add_files -norecurse -fileset $obj $files

# Set 'sim_1' fileset file properties for remote files
set file "$origin_dir/src/testbench/TestBench.vhd"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sim_1] [list "*$file"]]
set_property -name "file_type" -value "VHDL" -objects $file_obj

set file "$origin_dir/src/testbench/TestCounter.vhd"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sim_1] [list "*$file"]]
set_property -name "file_type" -value "VHDL" -objects $file_obj
